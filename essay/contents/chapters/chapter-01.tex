...
"The application need to handle 1000 concurrent requests"), the team can define
metrics and experiments to validate that choice before fully committing to it.
